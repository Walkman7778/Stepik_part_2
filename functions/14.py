#task in russian here --- https://stepik.org/lesson/508556/step/12?unit=500674
# here  I  use  function reduce for accumulating sum of squaring numbers 
def reduce(operation, items, initial_value):
    ...
    return acc
# here in function I used  (x + y ** 2) not (x ** 2 + y ** 2) because  it  is  a  difference 
def square(x, y):
    return x + y ** 2
