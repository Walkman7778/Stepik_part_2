# task here --- https://stepik.org/lesson/446698/step/14?unit=437004
...
result = {key: value for key, value in students.items() if (students[key][1] < 75) and (students[key][0] > 167)}